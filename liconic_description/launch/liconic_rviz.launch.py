...
def generate_launch_description():
  ...
  pkg_share = FindPackageShare(package='liconic_description').find('liconic_description')
  default_rviz_config_path = os.path.join(pkg_share, 'config/liconic_rviz_config.rviz') 
  default_urdf_model_path = os.path.join(pkg_share, 'urdf/liconic_module.xacro') 
  ...
  start_liconic_description_client = Node(
    condition=UnlessCondition(fake_hardware),
    package = "liconic_description",
    executable = 'liconic_description_client',
    name = 'liconicDescriptionNode',
    output = 'screen'
  )
  ...
  ld.add_action(start_liconic_description_client)
