...
def generate_launch_description():
  ...
  pkg_share = FindPackageShare(package='lyconic_description').find('lyconic_description')
  default_rviz_config_path = os.path.join(pkg_share, 'config/lyconic_rviz_config.rviz') 
  default_urdf_model_path = os.path.join(pkg_share, 'urdf/lyconic_module.xacro') 
  ...
  start_lyconic_description_client = Node(
    condition=UnlessCondition(fake_hardware),
    package = "lyconic_description",
    executable = 'lyconic_description_client',
    name = 'lyconicDescriptionNode',
    output = 'screen'
  )
  ...
  ld.add_action(start_lyconic_description_client)
