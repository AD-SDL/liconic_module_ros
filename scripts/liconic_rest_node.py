...
parser.add_argument("--device", type=str, default="/dev/ttyUSB3", help="Serial device for communicating with the device")
parser.add_argument("--resources_path", type=str, default="~/liconic_temp/resources/", help="Path to resources directory")
